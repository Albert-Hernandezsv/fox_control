  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        Tipos de facturas a las que puede aplicar:
<br><br>
      </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-xs-12">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <a href="index.php?ruta=crear-factura&idCliente='.$cliente["id"].'" class="btn btn-dark">Seleccionar</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-xs-12">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <a href="index.php?ruta=crear-factura-sujeto&idCliente='.$cliente["id"].'" class="btn btn-dark">Seleccionar</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-xs-12">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <a href="index.php?ruta=crear-ccf&idCliente='.$cliente["id"].'" class="btn btn-dark">Seleccionar</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-xs-12">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <a href="index.php?ruta=crear-factura-exportacion&idCliente='.$cliente["id"].'" class="btn btn-dark">Seleccionar</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-xs-12">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="vistas/img/nota_remision.png" alt="Card image cap">
                                    <div class="card-body">
                                        <a href="index.php?ruta=crear-nota-remision&idCliente='.$cliente["id"].'" class="btn btn-dark">Seleccionar</a>
                                    </div>
                                </div>
                            </div>
