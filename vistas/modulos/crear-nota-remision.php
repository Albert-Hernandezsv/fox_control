                                                        ...
                                                        <select name="nuevoIdProductoFactura[]" class="form-control select2 seleccionarProductoFactura">
                                                            ...
                                                            <?php
                                                                ...
                                                                foreach ($productos as $key => $value){
                                                                    if($value["stock"] > 0){
                                                                        echo '<option data-origen="'.$value["origen"].'" data-peso="'.$value["peso"].'" data-exento="'.$value["exento_iva"].'" data-value="'.$value["id"].'" data-precio="'.$value["precio_venta"].'" data-codigo="'.$value["codigo"].'">'.$value["nombre"].' '.$value["codigo"].'</option>';
                                                                    }
                                                                }
                                                            ?>
                                                        </select>
